...
async def extract_property_data(page):
    ...
    if next_data:
        ...
        try:
            context = next_data["props"]["pageProps"]["layoutData"]["sitecore"]["context"]
            properties = context.get("properties", [])

            if not properties:
                print("⚠️ No properties found under 'context.properties'")
                return
            ...
            for prop in properties:
                ...
                grouped_by_property[name] = grouped_units
