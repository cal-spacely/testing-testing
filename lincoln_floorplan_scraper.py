...
async def launch_persistent():
    ...
    context = await pw.chromium.launch_persistent_context(
        ...
        headless=True,  # debug mode; switch to True when stable
        args=[
...
async def scrape_floorplans(url: str):
    ...
    # async with async_playwright() as pw:
        ...
        #    headless = False,
        #    args=[
        #        "--disable-blin-features=AutomationControlled",
        #        "--no-sandbox"
        #    ]
        #)
        # page = await context.new_page()
...
async def main():
    ...
    excluded_communities = {
            ...
            "Ritterhouse Row","Meeting Street Lofts","Overlook Point","Simmons Park", "Legacy at Manchester Village",
            "Reserve at Park West","Summer Wind","1200 Broadway","Chapel Hill","Viero Twelve Oaks",
        }
    
    communities = [
        comm for comm in communities
        if comm.get("name") not in excluded_communities
    ]
